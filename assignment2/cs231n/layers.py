...
def batchnorm_forward(x, gamma, beta, bn_param):
    ...
    if mode == 'train':
        ...
        # This would've worked but we need to calculate each step seperately for backprop grad
        #calculation
        ...
        #Carrying out each calc seperately
        # formula y = gamma * x(k) + beta


        #mean = 1/N * sum(xi)
        #xmu = xi - mean(xi)
        #var = 1/N * sum (xi - mean) ** 2
        #x(k) = xmu / sqrt(var + eps)
